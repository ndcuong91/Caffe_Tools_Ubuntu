...
if __name__ == "__main__":
  ...
  parser.add_argument("tool_dir",
      help="The directory which contains caffe tools.")
  parser.add_argument("caffe_root",
      help="The root directory which contains caffe build.")
  ...
  if anno_type == "detection":
    cmd = "{}/convert_annoset" \
        ...
        " --gray={}" \
        " {} {} {}" \
        .format(tool_dir, anno_type, label_type, label_map_file, check_label,
    ...
    cmd = "{}/convert_annoset" \
        ...
        " --gray={}" \
        " {} {} {}" \
        .format(tool_dir, anno_type, min_dim, max_dim, resize_height,
