#ifndef CAFFE_QUANTRELU_LAYER_HPP_
#define CAFFE_QUANTRELU_LAYER_HPP_
...
class QuantReLULayer : public NeuronLayer<Dtype> {
 ...
 protected:
  ...
  /**
   * @brief Computes the error gradient w.r.t. the QuantReLU inputs.
   *
...
#endif  // CAFFE_QUANTRELU_LAYER_HPP_
